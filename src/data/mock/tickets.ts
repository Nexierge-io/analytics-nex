...
export const ticketsSummaryActivityKpis = [
  ...
  { label: "SLA Compliance", value: "94.7%", change: "+1.4%", trend: "up" as const },
...
export const universalRequestsKpis = [
  ...
  { label: "SLA Compliance", value: "96.2%", change: "+0.8%", trend: "up" as const },
...
export const manualTicketsKpis = [
  ...
  { label: "SLA Compliance", value: "89.7%", change: "-1.2%", trend: "down" as const },
...
export const orderingAppKpis = [
  ...
  { label: "Usage Rate", value: "54.3%", change: "+6.1%", trend: "up" as const },
  ...
  { label: "Conversion %", value: "59.9%", change: "+4.2%", trend: "up" as const },
];
...
export const catalogAdoptionKpis = [
  ...
  { label: "Catalog Open Rate", value: "62.7%", change: "+3.8%", trend: "up" as const },
  ...
  { label: "Catalog Conversion %", value: "24.2%", change: "+2.1%", trend: "up" as const },
];
...
export const universalRequestAdoptionKpis = [
  ...
  { label: "Usage Rate", value: "21.6%", change: "+2.8%", trend: "up" as const },
];
